...
import { movieList, search } from "../redux/reducers/movieReducer";
  ...
  return (
    <>
      {searchQuery === null || searchQuery === ""
        ? popularMovies.results?.slice(0, 18).map((item) => (
            <div
              key={item.id}
              style={{
                height: 550,
        ...
        : searchMovies.results?.slice(0, 18).map((item) => (
            <div
              key={item.id}
              style={{
                height: 550,
